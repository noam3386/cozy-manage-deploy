...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const managerNavItems = [
    ...
    { label: t('nav.reminders'), href: '/manager/reminders', icon: <Bell className="w-5 h-5" /> },
    { label: t('nav.vendorTasks'), href: '/manager/vendor-tasks', icon: <Users className="w-5 h-5" /> },
  ];
